...
- purchase_frequency (alım sıklığı) bilgisini kullanıcının verdiği cevaplardan çıkaramıyorsan MUTLAKA sor.
...
#### BU FAZIN TAMAMLANMASI DURUMUNDA VERMEN GEREKEN NİHAİ JSON YAPISI
{
    ...
    "COLLECTED_DATA": {
        ...
        "purchase_frequency": string, // kullanıcının verdiği cevaplardan çıkaramıyorsan MUTLAKA kullanıcıya sor
